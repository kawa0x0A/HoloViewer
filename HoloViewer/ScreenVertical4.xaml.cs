...
public partial class ScreenVertical4 : ContentPage
{
    public ScreenVertical4()
    {
        InitializeComponent();
    ...
    private async Task<Rect[]> CalcScreenCapturePosition()
    {
        ...
        {
            var x = captureToolbar.BindingModelView.IsCapture[0] ? captureToolbar.BindingModelView.IsCaptureYoutubePlayerOnly ? await ScreenCapture.GetYoutubePlayerWidth(captureToolbar.CaptureTargetWebviews[0]) + await ScreenCapture.GetYoutubePlayerWidth(captureToolbar.CaptureTargetWebviews[1]) + await ScreenCapture.GetYoutubePlayerWidth(captureToolbar.CaptureTargetWebviews[2]) : ScreenCapture.GetWebViewWidth(captureToolbar.CaptureTargetWebviews[0]) + ScreenCapture.GetWebViewWidth(captureToolbar.CaptureTargetWebviews[1]) + ScreenCapture.GetWebViewWidth(captureToolbar.CaptureTargetWebviews[2]) : captureToolbar.BindingModelView.IsCapture[1] ? captureToolbar.BindingModelView.IsCaptureYoutubePlayerOnly ? await ScreenCapture.GetYoutubePlayerWidth(captureToolbar.CaptureTargetWebviews[1]) + await ScreenCapture.GetYoutubePlayerWidth(captureToolbar.CaptureTargetWebviews[2]) : ScreenCapture.GetWebViewWidth(captureToolbar.CaptureTargetWebviews[1]) + ScreenCapture.GetWebViewWidth(captureToolbar.CaptureTargetWebviews[2]) : captureToolbar.BindingModelView.IsCapture[2] ? captureToolbar.BindingModelView.IsCaptureYoutubePlayerOnly ? await ScreenCapture.GetYoutubePlayerWidth(captureToolbar.CaptureTargetWebviews[2]) : ScreenCapture.GetWebViewWidth(captureToolbar.CaptureTargetWebviews[2]) : 0;
            var y = 0;
